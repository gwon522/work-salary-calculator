...
- 퇴직금 정산: 한국 시간 접속일을 기준으로 직전 3개월의 세전 임금과 재직기간을 이용해 예상 퇴직금을 계산합니다. 기간별 금액은 명세서에 맞게 수정할 수 있습니다.
...
퇴직금 자동 추정과 적용 제한은 [퇴직금 계산 기준](docs/retirement-calculation.md)을 참고합니다.
